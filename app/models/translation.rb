...
class Translation < ApplicationRecord
  ...
  belongs_to :expression_in_base_language, required: true, class_name: 'Expression',
                                           foreign_key: 'expression_in_base_language_id'
  belongs_to :expression_in_target_language, required: true, class_name: 'Expression',
                                             foreign_key: 'expression_in_target_language_id'
  enum review_status: { 'Need to Review' => 0, "Wouldn't mind reviewing" => 1, "Don't want to see again" => 2 },
       _default: 'Need to Review'
end
